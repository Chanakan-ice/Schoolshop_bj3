# โครงสร้างระบบ Web App ร้านค้าหมวดการงานอาชีพ (Career & Occupations Shopping App)

เอกสารฉบับนี้สรุปโครงสร้างสถาปัตยกรรม ไฟล์โครงการ ฐานข้อมูล และซอร์สโค้ดสำหรับนำขึ้น **GitHub** และ **Deploy ผ่าน Vercel** โดยใช้ **Google Apps Script (GAS)** ร่วมกับ **Google Sheets** เป็น Backend Database เพื่อจำหน่ายผลงานและอุปกรณ์ในหมวดการงานอาชีพ
...
| H | `pickup_location` | จุดนัดรับสินค้า (ห้องพักครูหมวดการงานอาชีพ / ห้องเรียน) |
...
- **`index.html`**: หน้าร้านค้าสำหรับนักเรียน สั่งซื้อผลงาน/อุปกรณ์หมวดการงานอาชีพ, ค้นหาตามหมวดหมู่, จัดการตะกร้า, กรอกข้อมูลนักเรียน, ชำระเงิน COD, ติดตามสถานะพัสดุ และสั่งจองล่วงหน้า
- **`seller.html`**: หน้า Admin Dashboard สำหรับครู/ผู้ขายหมวดการงาน ดูสรุปยอดขาย, อัปเดตสถานะออเดอร์, เพิ่ม/แก้ไข/ลบสินค้า, ดูสต็อกเหลือน้อย และตอบคำถาม
